...
class crafting_table(Block):
    ...
    def crafting_update(self, slot, item, amount):
        if item == None:
            ...
            if slot.stid != "minecraft:slot:crafting_table:out":
                if not slot.item and item: slot.setItem(item.getName(), amount)
                self.crafting_output_check()
    ...
    def crafting_output_check(self):
        ...
        for e in self.inv.slots:
            si.append([e])
        if self.check_crafting(crafting.Grid.crafting_1x1, crafting.craftinghandler.recipis[crafting.Grid.crafting_1x1],
                            si): return
        if self.check_crafting(crafting.Grid.crafting_1x2, crafting.craftinghandler.recipis[crafting.Grid.crafting_1x2],
        ...
        if self.check_crafting(crafting.Grid.crafting_2x1, crafting.craftinghandler.recipis[crafting.Grid.crafting_2x1],
                               [self.inv.slots[0:1], self.inv.slots[1:2],
                                self.inv.slots[3:4], self.inv.slots[4:5],
                                self.inv.slots[6:7], self.inv.slots[7:8]]): return
        if self.check_crafting(crafting.Grid.crafting_2x2, crafting.craftinghandler.recipis[crafting.Grid.crafting_2x2],
                               [self.inv.slots[0:2] + self.inv.slots[3:5],
                                self.inv.slots[1:3] + self.inv.slots[4:6],
                                self.inv.slots[3:5] + self.inv.slots[6:8],
                                self.inv.slots[4:6] + self.inv.slots[7:9]]): return
        if self.check_crafting(crafting.Grid.crafting_1x3, crafting.craftinghandler.recipis[crafting.Grid.crafting_1x3],
        ...
        if self.check_crafting(crafting.Grid.crafting_3x1, crafting.craftinghandler.recipis[crafting.Grid.crafting_3x1],
            [self.inv.slots[0:3],
             self.inv.slots[3:6],
             self.inv.slots[6:9]]): return
        if self.check_crafting(crafting.Grid.crafting_3x2, crafting.craftinghandler.recipis[crafting.Grid.crafting_3x2],
            [self.inv.slots[0:6],
             self.inv.slots[3:9]]): return
        if self.check_crafting(crafting.Grid.crafting_2x3, crafting.craftinghandler.recipis[crafting.Grid.crafting_2x3],
            [self.inv.slots[0:2]+self.inv.slots[3:5]+self.inv.slots[6:8],
             self.inv.slots[1:3] + self.inv.slots[4:6] + self.inv.slots[7:9]]): return
        if self.check_crafting(crafting.Grid.crafting_3x3, crafting.craftinghandler.recipis[crafting.Grid.crafting_3x3],
            [self.inv.slots[:9]]): return
        inv = self.inv
        Grid = crafting.Grid
        items = []
        itemnames = {}
        ...
        try:
            for c in recipis:
                ...
                for si in range(0, len(sll)):
                    sl = sll[si]
                    flag = len(self.stored) == len(slotgroups[0]) if grid != crafting.Grid.crafting_3x3 else True
                    for i, s in enumerate(sl):
                        if i < 9:
                            try:
                                if (not (s.item and s.item.getName() == c.input[i] and s.amount >= c.inputamount[i]) and flag) or (c.input[i] == None and flag):
